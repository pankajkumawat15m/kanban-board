...
const ToDoList = () => {
  ...
  const addTask = () => {
    ...
    setTasks((prevTasks) => [
      ...prevTasks,
      { ...formData, id: prevTasks.length + 1 },
    ]);
    setFormData({
      heading: "",
      username: users[0],
        ...
        {taskStages.map((stage) => (
          <div key={stage} className="task-section">
            ...
            <div className="task-list">
              {filteredTasks.filter((task) => task.stage === stage).length ===
              0 ? (
                ...
                filteredTasks
                  ...
                  .map((task) => (
                    <div key={task.id} className="task-box">
                      ...
                      <p className="task-time-remaining">
                      ...
                      <select
                        ...
                        value={task.stage}
                        onChange={(e) =>
                          updateTaskStage(task.id, e.target.value)
                        }
                      >
          ...
          <div className="task-form-overlay">
            <div className="task-form">
              ...
              <div className="form-group">
                ...
                ></textarea>
                <button className="submit-task-button" onClick={addTask}>
                  Submit Task
                </button>
              </div>
            </div>
